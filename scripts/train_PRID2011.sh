...
do
	...
	echo "================= using ${MODLE_NAME} with ${RELATION} module ======================"
        i=0
        for NUM_SAMPLES in 19455 19610
	# 19560 18959 18885 18779 19421 19245 19198 18902 
        do
            let i++
            echo "${i}"
            echo "${NUM_SAMPLES}"
        ...
        i=0
        for NUM_SAMPLES in 19011 18856
        # 18906 19507 19581 19687 19045 19221 19268 19564
        do
            let i++
            echo "${i}"
            echo "${NUM_SAMPLES}"
